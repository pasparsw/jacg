...
from src.generators.api_client_generator import ApiClientGenerator, API_CLIENT_TEMPLATE_FILE_PATH
...
class TestApiClientGenerator(unittest.TestCase):
    def test_generate(self, load_file_content_mock):
        ...
        load_file_content_mock.assert_called_once_with(API_CLIENT_TEMPLATE_FILE_PATH)
        context = {
            "model": api_model,
